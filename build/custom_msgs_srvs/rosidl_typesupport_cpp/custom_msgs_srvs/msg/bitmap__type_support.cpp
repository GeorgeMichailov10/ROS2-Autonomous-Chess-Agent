...
static const _Bitmap_type_support_symbol_names_t _Bitmap_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msgs_srvs, msg, Bitmap)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msgs_srvs, msg, Bitmap)),
  }
};
...
{
  return &::custom_msgs_srvs::msg::rosidl_typesupport_cpp::Bitmap_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, custom_msgs_srvs, msg, Bitmap)() {
  return get_message_type_support_handle<custom_msgs_srvs::msg::Bitmap>();
}
