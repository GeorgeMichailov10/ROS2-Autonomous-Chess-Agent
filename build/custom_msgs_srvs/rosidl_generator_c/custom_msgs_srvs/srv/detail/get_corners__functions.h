...
#ifndef CUSTOM_MSGS_SRVS__SRV__DETAIL__GET_CORNERS__FUNCTIONS_H_
#define CUSTOM_MSGS_SRVS__SRV__DETAIL__GET_CORNERS__FUNCTIONS_H_
...
/// Initialize srv/GetCorners message.
/**
...
/// Finalize srv/GetCorners message.
/**
...
/// Create srv/GetCorners message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs_srvs__srv__GetCorners_Request__init().
...
/// Destroy srv/GetCorners message.
/**
 * It calls
 * custom_msgs_srvs__srv__GetCorners_Request__fini()
...
/// Check for srv/GetCorners message equality.
/**
...
/// Initialize array of srv/GetCorners messages.
/**
...
/// Finalize array of srv/GetCorners messages.
/**
 * It calls
 * custom_msgs_srvs__srv__GetCorners_Request__fini()
...
/// Create array of srv/GetCorners messages.
/**
 * It allocates the memory for the array and calls
 * custom_msgs_srvs__srv__GetCorners_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/GetCorners messages.
/**
 * It calls
 * custom_msgs_srvs__srv__GetCorners_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/GetCorners message array equality.
/**
...
/// Copy an array of srv/GetCorners messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * custom_msgs_srvs__srv__GetCorners_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs_srvs
...
/**
 * It calls
 * custom_msgs_srvs__srv__GetCorners_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs_srvs
...
/**
 * It allocates the memory for the array and calls
 * custom_msgs_srvs__srv__GetCorners_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_custom_msgs_srvs
...
/**
 * It calls
 * custom_msgs_srvs__srv__GetCorners_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // CUSTOM_MSGS_SRVS__SRV__DETAIL__GET_CORNERS__FUNCTIONS_H_
